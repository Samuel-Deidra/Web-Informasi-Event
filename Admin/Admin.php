        ...
        <div class="modal-body">
          ...
          <form id="formStep1">
            <div class="mb-3">
              ...
              <div class="row">
                <div class="col-6">
                  <input type="date" class="form-control" id="tanggalPendaftaranAwal" placeholder="Dari" required>
                </div>
                <div class="col-6">
                  <input type="date" class="form-control" id="tanggalPendaftaranAkhir" placeholder="Sampai" required>
                </div>
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="namaEvent" placeholder="Masukkan nama event" required>
            </div>
            ...
            <div class="row">
              <div class="col-12 mb-3">
                ...
                <select class="form-select" id="statusEvent">
          ...
          <form id="formStep2" class="d-none">
            ...
            <div class="mb-2">
              ...
              <textarea class="form-control" id="deskripsi" rows="4" placeholder="Tuliskan deskripsi event..."></textarea>
            </div>
            <div class="text-end mt-3">
        ...
        <div class="modal-body">
          ...
          <form id="editFormStep1">
            ...
            <div class="mb-3">
              ...
              <div class="row">
                <div class="col-6">
                  <input type="date" class="form-control" id="editTanggalPendaftaranAwal" placeholder="Dari" required>
                </div>
                <div class="col-6">
                  <input type="date" class="form-control" id="editTanggalPendaftaranAkhir" placeholder="Sampai" required>
                </div>
              </div>
            </div>
