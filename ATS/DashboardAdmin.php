    ...
    <header class="navbar">
        ...
        <div class="icon-user">
            ...
            <div class="dropdown-menu" id="logoutMenu">
                <a href="Login_page.php" class="logout-btn">Keluar</a>
            </div>
        </div>
    </header>
    ...
    <main class="container">
        <div class="dashboard-header">
            ...
            <nav class="nav-tabs">
                ...
                <a href="#" id="tabHistory">Riwayat</a>
            </nav>
        </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr class="desc-row">
                            <td colspan="8">
                                <div class="desc-box">
                                    <p><strong>Lokasi : </strong>parkiran techno preneur politeknik negeri batam</p>
                                    <br>
                                    <p><strong>Link : </strong>https://www.jobfair2025.com</p><br>
                                    <p><strong>Deskripsi : </strong>Pameran lowongan kerja dan magang dari berbagai
                                        perusahaan nasional dan startup</p>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr class="desc-row">
                            <td colspan="8">
                                <div class="desc-box">
                                    ...
                                    <p><strong>Deskripsi : </strong>konser music tahunan dengan penampilan band kapus
                                        dan bintang tamu</p><br>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr class="desc-row">
                            <td colspan="8">
                                <div class="desc-box">
                                    <p><strong>Lokasi : </strong>Lapangan futsal politeknik negeri batam</p><br>
                                    <p><strong>Link : </strong>https://www.sportsdaypoltek.com</p><br>
                                    <p><strong>Deskripsi : </strong>Turnamen olahraga antar-fakultas meliputi futsal,
                                        basket, badminton, dan e-sport.</p><br>
                            </td>
                        </tr>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr class="history-desc-row">
                            <td colspan="9">
                                <div class="desc-box">
                                    <p><strong>Lokasi : </strong>Gedung Traine Politeknik Negeri Batam
                                    </p>
                        ...
                        <tr class="history-desc-row">
                            <td colspan="9">
                                <div class="desc-box">
                                    <p><strong>Lokasi : </strong>Depan Gedung Techno, Politeknik Negeri Batam
                                    </p>
                        ...
                        <tr class="history-desc-row">
                            <td colspan="9">
                                <div class="desc-box">
                                    <p><strong>Lokasi : </strong> Depan Techno Politeknik Negeri Batam
                                    </p>
                                    <p><strong>Link : </strong>https://www.festivalpoltek.com </p>
                                    <p><strong>Deskripsi : </strong> Summer Art Festival 2025 adalah ajang seni tahunan
                                        yang diselenggarakan oleh Unit Kegiatan Mahasiswa Kuas Polibatam. Mengusung
                                        semangat “Salam Seni, Kreativitas Tanpa Batas!”, festival ini menjadi wadah bagi
                                        pelajar SMA/SMK sederajat untuk menyalurkan bakat dan mengekspresikan diri
                                        melalui berbagai lomba seperti Dance, Tari Tradisional, Solo Song, dan Lukis.
                                    </p>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="modal-content">
            <form id="event" enctype="multipart/form-data" method="POST" action="Crud.php">
                ...
                <div id="formStep2" class="form-step">
                    ...
                    <input type="text" id="startInput" placeholder="Hari, Tanggal (contoh: Senin, 24 Oktober 2025)"
                        required />
