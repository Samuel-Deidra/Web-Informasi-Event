...
//     document.getElementById('editStatusEvent').value = event.status || 'Pendaftaran dibuka';
...
//     if (!namaEvent || !tanggalEvent || !tanggalPendaftaranAwal || !tanggalPendaftaranAkhir || !jamEvent) {
...
//     formData.append('link', document.getElementById('tautan').value);
//     formData.append('deskripsi', document.getElementById('deskripsi').value);
//     formData.append('biaya', document.getElementById('biaya').value || 0);
//     formData.append('peserta', document.getElementById('peserta').value);
//     formData.append('status', document.getElementById('statusEvent').value);
...
//     const tanggalPendaftaranAwal = document.getElementById('editTanggalPendaftaranAwal').value;
//     const tanggalPendaftaranAkhir = document.getElementById('editTanggalPendaftaranAkhir').value;
...
//     formData.append('tanggal_pendaftaran_akhir', tanggalPendaftaranAkhir);
//     formData.append('jam_event', jamEvent);
//     formData.append('lokasi', document.getElementById('editLokasi').value);
//     formData.append('link', document.getElementById('editTautan').value);
//     formData.append('deskripsi', document.getElementById('editDeskripsi').value);
//     formData.append('biaya', document.getElementById('editBiaya').value || 0);
//     formData.append('peserta', document.getElementById('editPeserta').value);
//     formData.append('status', document.getElementById('editStatusEvent').value);
//     formData.append('kategori', document.getElementById('editKategoriEvent').value);
...
//         const response = await fetch(`${API_URL}?id=${currentRowToDelete.eventId}`, {
//             method: 'DELETE'
//         });
...
//         if (result.success) {
//             eventsData = result.data.filter(event => event.status !== 'Selesai');
//             historyData = result.data.filter(event => event.status === 'Selesai');
...
//         tbody.innerHTML = '<tr><td colspan="8" class="text-center py-4">Tidak ada data event</td></tr>';
//         return;
//     }
...
//         historyTbody.innerHTML = '<tr><td colspan="8" class="text-center py-4">Tidak ada data history</td></tr>';
//         return;
//     }
...
//             statusBadge = '<span class="badge-pill badge-on">Sedang Berlangsung</span>';
//             break;
//         case 'Selesai':
...
//                             <div class="detail-value">${event.jam_event} WIB</div>
//                         </div>
//                     </div>
//                     <div class="detail-item">
//                         <div class="detail-icon">
...
//                             <div class="detail-value">${event.lokasi || 'Tidak tersedia'}</div>
//                         </div>
//                     </div>
//                     <div class="detail-item">
//                         <div class="detail-icon">
...
//                                 ${event.link ? `<a href="${event.link}" class="detail-link" target="_blank">${event.link}</a>` : 'Tidak tersedia'}
//                             </div>
//                         </div>
//                     </div>
...
//                             <div class="detail-value">${event.deskripsi || 'Tidak ada deskripsi'}</div>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
//         activeTbody.innerHTML = '<tr><td colspan="8" class="text-center py-4">Tidak ada data yang cocok dengan filter</td></tr>';
//         return;
//     }
